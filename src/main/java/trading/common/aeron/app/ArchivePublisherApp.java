...
import trading.common.aeron.ArchivePublisherAgent;

public class ArchivePublisherApp {
    private static final Logger LOGGER = LoggerFactory.getLogger(ArchivePublisherApp.class);
    ...
    public static void main(final String[] args) {
        ...
        if (archiveHost == null || controlPort == null || eventsPort == null) {
            ...
            final var runner =
                    new AgentRunner(new SleepingMillisIdleStrategy(), ArchivePublisherApp::errorHandler, null, hostAgent);
